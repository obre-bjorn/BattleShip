...
function createUI(){
    ...
    const updateUI = (coordinates) =>{

        const[y,x] = coordinates
        const cellAttacked = document.querySelector(`[data-row="${y}"][data-col="${x}"]`)
    ...
    const placeAttack = (cell,players) => {
        ...
        players[0].play([clickedRow,clickedCol],players[1].playerGameboard)
        updateUI([clickedRow,clickedCol])
